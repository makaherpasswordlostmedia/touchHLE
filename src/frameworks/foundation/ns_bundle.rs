...
-(id)localizedStringForKey:(id)key
    ...
    log!("localizedStringForKey {} {} {}",
            ...
            if key == nil { std::borrow::Cow::from("(null)") } else { ns_string::to_rust_string(env, value) },
            if key == nil { std::borrow::Cow::from("(null)") } else { ns_string::to_rust_string(env, tableName) }
    );
    value
}
